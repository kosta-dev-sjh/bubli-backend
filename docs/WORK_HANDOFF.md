...
Last checked: 2026-06-25 03:34 KST
...
| pending | `test: 엔티티 경계 가드 추가` | `chore/entity-boundary-guards` | local only | #28 기준 stacked PR 예정. 로컬 검증 통과. PR 생성 후 GitHub Actions checks 확인 필요 |
...
7. `chore/entity-boundary-guards` PR 생성 후 GitHub Actions CI를 확인한다.
