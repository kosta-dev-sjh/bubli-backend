...
| pending | `[feat] 자료 AI 문서 조회 API 추가` | `feature/resource-ai-document-api` | local only | #35 기준 stacked PR 예정. 로컬 검증 통과. PR 생성 후 GitHub Actions checks 확인 필요 |
...
7. `feature/resource-ai-document-api` PR 생성 후 GitHub Actions CI를 확인한다.
