...
Last checked: 2026-06-25 16:08 KST
...
2. #83, #85는 `develop` 대상, CI 통과, review required 상태이므로 팀 리뷰 후 병합 검토 가능하다.
...
7. 남은 draft PR은 #39, #47, #62이며 각각 DIRTY 또는 BLOCKED 해소 뒤 ready 전환한다.
