...
- `git diff --check` 통과
- PR #88 head `1ef41ef` 기준 GitHub checks 없음. 현재 CI workflow의 `pull_request.branches`가 `develop`, `main`, `feature/**`만 포함하고, PR #88 base가 `chore/latest-docs-2026-06-25`라서 check run이 생성되지 않는다.
