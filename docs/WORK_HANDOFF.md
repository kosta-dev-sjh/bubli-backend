...
| pending | `[feat] 자료 분석 작업 생성 API 추가` | `feature/analyze-resource-job-api` | local only | #37 기준 stacked PR 예정. 로컬 검증 통과. PR 생성 후 GitHub Actions checks 확인 필요 |
...
9. `feature/analyze-resource-job-api` PR 생성 후 GitHub Actions CI를 확인한다.
