...
| pending | `[feat] 프로젝트룸 AI 문서 목록 조회 API 추가` | `feature/room-ai-documents-api` | local only | #36 기준 stacked PR 예정. 로컬 검증 통과. PR 생성 후 GitHub Actions checks 확인 필요 |
...
8. `feature/room-ai-documents-api` PR 생성 후 GitHub Actions CI를 확인한다.
