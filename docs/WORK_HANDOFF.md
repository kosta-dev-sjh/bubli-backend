...
| pending | `[feat] 저장 용량 조회 API 추가` | `feature/storage-usage-api` | local only | #31 기준 stacked PR 예정. 로컬 검증 통과. PR 생성 후 GitHub Actions checks 확인 필요 |
...
4. `feature/storage-usage-api` PR 생성 후 GitHub Actions CI를 확인한다.
