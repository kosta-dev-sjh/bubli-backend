...
Last checked: 2026-06-25 02:49 KST
...
| 현재 확인 브랜치 | `feature/agent-suggestion-list-api` |
| 원격 기준 브랜치 | `develop` |
...
| TBD | `[feat] 에이전트 제안함 조회 API 추가` | `feature/agent-suggestion-list-api` | local latest | #32 기준 stacked PR로 생성 예정. 로컬 검증 통과. PR 생성 후 GitHub Actions checks 확인 필요 |
