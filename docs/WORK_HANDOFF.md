...
Last checked: 2026-06-24 21:42:53 KST
...
| 현재 확인 브랜치 | `feature/entity-flyway-alignment` |
| 원격 기준 브랜치 | `develop` |
...
- `./gradlew compileTestJava` 통과 (2026-06-24 21:41 KST)
- `./gradlew cleanTest test` 통과 (2026-06-24 21:41 KST)
- `git diff --check` 통과 (2026-06-24 21:42 KST)
