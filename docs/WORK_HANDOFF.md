...
| #35 | `[feat] 에이전트 제안 상태 수정 API 추가` | `feature/agent-suggestion-update-api` | `243627f` | #34 기준 draft stacked PR 생성 완료. 로컬 검증 통과. GitHub Actions checks 없음. base #34에는 #28의 stacked PR CI workflow가 아직 포함되지 않음 |
