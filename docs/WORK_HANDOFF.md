...
Last checked: 2026-06-25 18:16 KST
...
| #27 | `test: Entity Flyway 정합성 검사 추가` | `feature/entity-flyway-alignment` | `aab54a8` | #26 기준 stacked PR. 최신 #26 병합 후 로컬 검증 통과, GitHub mergeState CLEAN |
| #28 | `ci: stacked PR 테스트 검증 보강` | `feature/testcontainers-ci-foundation` | `bb89d1d` | #27 기준 stacked PR. 최신 #27 병합 후 로컬 검증과 GitHub Actions `build` 통과 |
| #38 | `[test] 엔티티 경계 가드 추가` | `chore/entity-boundary-guards` | `89603fb` | #28 기준 stacked PR. 최신 #28 병합 후 로컬 검증과 CI 재확인 필요 |
