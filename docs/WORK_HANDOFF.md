...
Last checked: 2026-06-25 03:27 KST
...
| 현재 확인 브랜치 | `feature/room-ai-documents-api` |
| 원격 기준 브랜치 | `develop` |
...
| #37 | `[feat] 프로젝트룸 AI 문서 목록 조회 API 추가` | `feature/room-ai-documents-api` | `f60e743` | #36 기준 draft stacked PR 생성 완료. 로컬 검증 통과. GitHub Actions checks 없음. base #36에는 #28의 stacked PR CI workflow가 아직 포함되지 않음 |
...
9. 추천 다음 작업은 Entity/Flyway 정합성 점검이다. 특히 `agent_model_call_logs`, `agent_suggestions`, `resource` 관련 테이블을 먼저 본다.
