 ...
 * memo         - 개인 메모 CRUD, 프로젝트룸/자료 연결 메모
 *               → 엔티티: Memo (user_id, room_id, resource_id, body)
 * timer        - 타이머 시작/일시정지/종료, 작업 시간 기록
 *               → 엔티티: TimeLog (user_id, task_id, started_at, ended_at)
 ...
 *
 * 개인 TODO와 프로젝트룸 TODO가 대시보드에 표시되더라도
 * TODO 원본은 work.task가 소유한다.
 */
